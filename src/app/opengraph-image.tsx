        ...
        >
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
              <span style={{ fontSize: "32px", fontWeight: 700, color: "#06b6d4" }}>
                50+
              </span>
              <span style={{ fontSize: "14px", color: "#64748b" }}>Clinical Cases</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
              <span style={{ fontSize: "32px", fontWeight: 700, color: "#10b981" }}>
                ACR
              </span>
              <span style={{ fontSize: "14px", color: "#64748b" }}>Criteria Based</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
              <span style={{ fontSize: "32px", fontWeight: 700, color: "#8b5cf6" }}>
                5
              </span>
              <span style={{ fontSize: "14px", color: "#64748b" }}>Specialty Tracks</span>
            </div>
          </div>
        </div>
